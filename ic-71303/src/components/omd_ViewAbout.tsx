...
export default function ViewAbout() {
  return (
    <div className="font-koho flex pt-[120px] h-[550px] w-[550px] flex-col items-center justify-center gap-[50px]">
      <div className="flex h-[80%] w-full flex-col items-center justify-start gap-[20px]">
        <div>
          <p className="font-italiana text-center text-[63px] leading-[50px]">OMD</p>
        </div>
        <div className="text-center">
          <p>
            ...
            chuyện đậm chất nghệ thuật, nuôi dưỡng tâm hồn, mang lại sự thư thái và khơi dậy cảm hứng. 
          </p>
        </div>
        <div className="text-center">
          <p>
            Chúng tôi làm việc với sự cầu toàn và sự tận tâm, sự khởi đầu sẽ từ
      ...
      <div className="flex h-[20%] w-full flex-col items-center justify-start gap-[10px]">
